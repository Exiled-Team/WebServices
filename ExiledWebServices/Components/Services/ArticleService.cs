...
namespace ExiledWebServices.Components.Services
{
    /// <summary>
    ...
    {
        private static ArticleService _instance;

        /// <summary>
        /// Gets the singleton instance of the <see cref="ArticleService"/>.
        /// </summary>
        public static ArticleService Instance => _instance ??= new();
        ...
        public MarkdownArticle? GetArticleByName(string name) => Articles.FirstOrDefault(article => article.Name == name) ?? null;
    }
}
